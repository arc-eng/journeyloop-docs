...
!!! note "Currently quiet"
    SWE is not auto-triggered. `ready-for-dev` is the final pipeline stage — Marco initiates dev work manually.
...
**Role:** Owns the JourneyLoop documentation site (MkDocs Material, live at [http://192.168.1.30:8001](http://192.168.1.30:8001)).
